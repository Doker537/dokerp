...
const Index = () => {
  ...
  // Этот эффект ловит якорь #booking и скроллит к форме
  useEffect(() => {
  ...
  return (
    <main className="bg-background min-h-screen">
      ...
      {/* Обернули в id="booking" для надежности */}
      <div id="booking">
        ...
        <div className="container mx-auto px-6 md:px-12 text-center">
          ...
          >
            <p className="font-body text-muted-foreground mb-6">
              Хотите обсудить съёмку? Напишите мне напрямую
            </p>
