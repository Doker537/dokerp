  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              <span className="font-body text-sm text-foreground">ВКонтакте</span>
            </a>
            <a
            ...
            >
              ...
              <span className="font-body text-sm text-foreground">Telegram</span>
            </a>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <motion.button
        ...
        className="w-14 h-14 rounded-full bg-accent text-accent-foreground flex items-center justify-center shadow-lg shadow-accent/20"
      >
